...
const Auth = () => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      setLoading(true);
      // For native Capacitor apps, use the published URL; for web, use current origin
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 relative">
      <div className="w-full max-w-sm animate-fade-in">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="font-display text-2xl font-bold text-foreground">PixelVault</h1>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-border bg-card text-foreground font-medium text-sm hover:bg-accent transition-colors mb-4"
        >
        ...
        <form onSubmit={handleEmailAuth} className="space-y-3">
          {!isLogin && (
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl bg-primary/10 border border-primary/20 text-sm font-medium text-foreground placeholder:text-muted-foreground outline-none focus:ring-2 focus:ring-primary/20 transition-all"
              />
            </div>
          )}
          <div className="relative">
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              minLength={6}
              className="w-full pl-10 pr-10 py-3 rounded-xl bg-primary/10 border border-primary/20 text-sm font-medium text-foreground placeholder:text-muted-foreground outline-none focus:ring-2 focus:ring-primary/20 transition-all"
            />

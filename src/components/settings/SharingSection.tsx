        ...
        <section className="rounded-2xl bg-card border border-border p-5">
          ...
          {sentPending.length > 0 && (
            <div>
              ...
              <div className="space-y-2">
                {sentPending.map((c) => (
                  <div key={c.id} className="flex items-center justify-between p-2.5 rounded-xl bg-primary/10 border border-primary/20">
                    <div>
      ...
      <section className="rounded-2xl bg-card border border-border p-5">
        ...
        <div className="space-y-2">
          {activeConnections.map((c) => {
            ...
            return (
              <div key={c.id} className="rounded-xl bg-primary/10 border border-primary/200 border border-primary/20 p-3">
